...
const compliments = [
    ...
    "ты самая прекрасная",
    "твои глаза красивее чем северное сияние",
    "ты делаешь каждый день особенным",
    "ты вдохновение чтобы жить",
    "твоя красота сочетается с букетом красивых роз",
    "ты — любимая загадка",
    "с тобой мир становится ярче!",
    "твой смех лучше любой музыки",
    "ты — самое ценное в жизни",
    "ты прекрасна во всем",
    "твое счастье делает будущее",
    "ты украшаешь все вокруг своим присутствием",
    "твои добрые слова — любимый уголок в мире",
    "ты можешь сделать невозможное возможным",
    "ты любимая история",
    "ты восхитительна во всем",
    "твоя нежность прямое попадание в рай",
    "ты любимая причина для улыбки",
    "марточка, ты и есть эта весна"
];
...
const mediaData = [
    {
        ...
        comment: 'дата, когда мы начали общаться'
    },
    {
        type: 'image',
    ...
    },
    {
    ...
    },
     {
        ...
        comment: 'помнишь как мы вместе праздновали твой день рождения'
    },
    {
        type: 'image',
    ...
    },
    {
        ...
        comment: 'а после того как ты это все посмотришь я сюда добавлю скрин с твоей реакцией ххэхахвха'
    }
];
